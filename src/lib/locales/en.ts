...
export const en: Strings = {
  ...
  idRegister: 'Register this product',
  idRegistering: 'Registering…',
  idWhy: 'Give this product an identity number, so the world can see that you made it.',
  idWhat: 'One photo, one number, and a QR code you can tie to the product itself. Anyone can scan it and see that you are the maker.',
  idMaker: 'Original maker',
  idOwner: 'Held now by',
  idYou: 'you',
  ...
  idConflictWhy: 'A very similar photo is already registered. It may be another piece of yours, or you may be selling work someone else made. Both are fine — just say which.',
  idIMadeIt: 'I made this one too',
  idIAmSelling: 'They made it, I am selling it',
  idOwnerSaid: 'Done. The maker’s name stays as it is, and yours is recorded as the seller.',
  idConflictSaid: 'This product may already be registered. Look below.',
  idNotChecked: 'There was no internet, so we could not compare this with existing registrations. The identity has been created.',
  idChip: 'Register',
}